                ...
                <td>
                    <table class="layui-table">
                        ...
                        <tr>
                            ...
                            <th style="width:9%"  class="list-center" >节点标题</th>
                            <th style="width:9%"  class="list-center" >节点名称</th>
                            <th style="width:8%"  class="list-center" >类型</th>
                            <th style="width:5%"  class="list-center" >层级</th>
                            <th style="width:8%"  class="list-center" >序号</th>
                            <th style="width:8%"  class="list-center" >状态</th>
                            <th style="width:8%"  class="list-center" >方法列表</th>
                            <th style="width:12%" class="list-center" >创建时间</th>
                            <th style="width:12%" class="list-center" >更新时间</th>
