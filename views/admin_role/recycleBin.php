    ...
    <table class="layui-table">
        ...
        <?php foreach ($list as $item): ?>
            <tr>
                ...
                <td class="list-center">
                    <button class="layui-btn layui-btn-xs layui-bg-green" title="查看用户列表" onclick="x_admin_show('用户列表', '/AdminGroup/users?id=<?php echo $item['id']; ?>')">查看</button>
                </td>
                <td class="list-center">
                    <button class="layui-btn layui-btn-xs layui-bg-red" title="查看授权列表" onclick="x_admin_show('授权列表', '/AdminGroup/nodes?id=<?php echo $item['id']; ?>')">查看</button>
                </td>
