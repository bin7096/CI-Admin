...
<div class="x-body">
    <form class="layui-form" action="javascript:;" id="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="icon" placeholder="请输入图标字符实体" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.ajax({
                ...
                data: {name:arr.name,icon:arr.icon,sort:arr.sort,status:arr.status,remark:arr.remark},
                dataType: "json",
