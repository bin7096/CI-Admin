    ...
    <form class="layui-form" action="javascript:;" id="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" placeholder="请输入分组名称" autocomplete="off" class="layui-input" value="<?php echo $name ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">分组图标：</label>
            <div class="layui-input-block">
                <input type="text" name="icon" placeholder="请输入图标字符实体" autocomplete="off" class="layui-input" value="<?php echo htmlspecialchars($icon) ?>">
            </div>
        </div>
        <div class="layui-form-item">
